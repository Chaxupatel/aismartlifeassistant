...
/// Screen to edit an existing task reminder.
...
class _EditReminderScreenState extends ConsumerState<EditReminderScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (!_isInitialized) {
      // Find the reminder matching this ID in active provider state
      final reminders = ref.read(remindersProvider);
      
      Reminder? reminder;
      for (final r in reminders) {
        if (r.id == widget.reminderId) {
          reminder = r;
          break;
        }
      }
      ...
      if (reminder != null) {
        ...
        _selectedTime = TimeOfDay(hour: reminder.dateTime.hour, minute: reminder.dateTime.minute);
        _selectedRepeatType = reminder.repeatType;
        _enableNotification = reminder.enableNotification;
        _enableAlarm = reminder.enableAlarm;
  ...
  void _handleSave() {
    if (_formKey.currentState!.validate()) {
      ...
      final updatedReminder = Reminder(
        ...
        isCompleted: false, // Maintain completion state or reset
